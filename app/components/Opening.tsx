        ...
        >
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center gap-4">
            ...
            <div className="relative">
              ...
              <span
                className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[18px] md:text-[22px] font-medium text-black lowercase tracking-tight leading-none"
